...
# Base system prompt for QA generation
SYSTEM_PROMPT = (
...
def main():
    parser = argparse.ArgumentParser(description="Generate SPSC QA per item using local Qwen-VL with vLLM.")
    ...
    parser.add_argument("--pairs", type=int, default=1, help="Number of QA pairs in the {n} placeholder")
    ...
    try:
        system_prompt = system_prompt.format(n=args.pairs)
    except Exception:
        pass
